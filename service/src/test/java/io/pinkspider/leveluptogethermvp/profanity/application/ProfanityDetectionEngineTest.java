...
class ProfanityDetectionEngineTest {
    ...
    class LenientModeTest {
        ...
        void normalTextPasses() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("좋은 하루 되세요", ProfanityDetectionMode.LENIENT, false, 0);
        ...
        void detectDirectMatch() {
            ...
            ProfanityDetectionResult result = detectionEngine.detect("시발 뭐야", ProfanityDetectionMode.LENIENT, false, 0);
        ...
        void cannotDetectSpacedProfanity() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("시 발 뭐야", ProfanityDetectionMode.LENIENT, false, 0);
    ...
    class NormalModeTest {
        ...
        void normalTextPasses() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("좋은 하루 되세요", ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void detectDirectMatch() {
            ...
            ProfanityDetectionResult result = detectionEngine.detect("시발 뭐야", ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void detectSpacedProfanity() {
            ...
            ProfanityDetectionResult result = detectionEngine.detect("시 발 뭐야", ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void detectCaseInsensitiveProfanity() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("FUCK you", ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void detectChosungProfanity() {
            ...
            ProfanityDetectionResult result = detectionEngine.detect("ㅅㅂ 뭐야", ProfanityDetectionMode.NORMAL, true, 0);
    ...
    class StrictModeTest {
        ...
        void normalTextPasses() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("좋은 하루 되세요", ProfanityDetectionMode.STRICT, true, 1);
        ...
        void detectSimilarWordWithLevenshtein() {
            ...
            ProfanityDetectionResult result = detectionEngine.detect(
                    "시발놈", ProfanityDetectionMode.STRICT, true, 1 // threshold 1
                    );
        ...
        void noSimilarWordWithZeroThreshold() {
            ...
            ProfanityDetectionResult result = detectionEngine.detect(
                    "시팔 뭐야", ProfanityDetectionMode.STRICT, true, 0 // threshold 0
                    );
    ...
    class EmptyInputTest {
        ...
        void nullInputReturnsNoProfanity() {
            ProfanityDetectionResult result = detectionEngine.detect(null, ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void emptyInputReturnsNoProfanity() {
            ProfanityDetectionResult result = detectionEngine.detect("", ProfanityDetectionMode.NORMAL, true, 0);
