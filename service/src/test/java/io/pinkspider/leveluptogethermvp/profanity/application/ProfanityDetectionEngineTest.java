...
class ProfanityDetectionEngineTest {
    ...
    @Mock private ProfanityValidationService profanityValidationService;
    ...
    class LenientModeTest {
        ...
        void normalTextPasses() {
            when(profanityValidationService.getActiveProfanityWords())
                    .thenReturn(createMockProfanityWords());
        ...
        void detectDirectMatch() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("시발 뭐야", ProfanityDetectionMode.LENIENT, false, 0);
    ...
    class NormalModeTest {
        ...
        void detectDirectMatch() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("시발 뭐야", ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void detectSpacedProfanity() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("시 발 뭐야", ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void detectChosungProfanity() {
            ...
            ProfanityDetectionResult result =
                    detectionEngine.detect("ㅅㅂ 뭐야", ProfanityDetectionMode.NORMAL, true, 0);
    ...
    class EmptyInputTest {
        ...
        void nullInputReturnsNoProfanity() {
            ProfanityDetectionResult result =
                    detectionEngine.detect(null, ProfanityDetectionMode.NORMAL, true, 0);
        ...
        void emptyInputReturnsNoProfanity() {
            ProfanityDetectionResult result =
                    detectionEngine.detect("", ProfanityDetectionMode.NORMAL, true, 0);
