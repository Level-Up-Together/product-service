...
import io.pinkspider.global.config.datasource.properties.MissionDataSourceProperties;
...
public class MissionDataSourceConfig {
    ...
    public MissionDataSourceConfig(MissionDataSourceProperties properties, @Nullable SshTunnel sshTunnel) {
