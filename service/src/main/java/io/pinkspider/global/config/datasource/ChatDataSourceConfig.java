...
import io.pinkspider.global.config.datasource.properties.ChatDataSourceProperties;
...
public class ChatDataSourceConfig {
    ...
    public ChatDataSourceConfig(
            ChatDataSourceProperties properties, @Nullable SshTunnel sshTunnel) {
