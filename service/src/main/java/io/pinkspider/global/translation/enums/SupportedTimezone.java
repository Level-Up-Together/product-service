...
/** 지원 타임존 유틸리티. locale 및 국가코드(ISO 3166-1 alpha-2)로부터 기본 타임존을 추론한다. */
public final class SupportedTimezone {
    ...
    /** locale → 기본 타임존 매핑 */
    private static final Map<String, String> LOCALE_TO_TIMEZONE =
            Map.of(
                    "ko", "Asia/Seoul",
                    "ja", "Asia/Tokyo",
                    "ar", "Asia/Riyadh",
    ...
    private static final Map<String, String> COUNTRY_TO_TIMEZONE =
            Map.ofEntries(
    ...
    /**
     * 타임존 결정 우선순위: 1. 클라이언트가 직접 전달한 timezone (유효한 경우) 2. 국가코드 기반 추론 3. locale 기반 추론 4. 기본값
     * (Asia/Seoul)
     */
