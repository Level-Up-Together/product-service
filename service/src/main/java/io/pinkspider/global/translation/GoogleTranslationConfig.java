...
public class GoogleTranslationConfig {
    ...
    /** 요청 타임아웃 설정 - 연결 타임아웃: 5초 - 읽기 타임아웃: 10초 */
    @Bean
    ...
    /** 재시도 설정 - 최대 3회 재시도 - 초기 대기: 100ms - 최대 대기: 1초 */
    @Bean
    ...
    public static class GoogleTranslationErrorDecoder implements ErrorDecoder {
        ...
        public Exception decode(String methodKey, feign.Response response) {
            ...
            return switch (status) {
                ...
                case 401, 403 ->
                        new GoogleTranslationException("Google API 인증에 실패했습니다. API Key를 확인하세요.");
                case 429 -> new GoogleTranslationException("API 요청 한도를 초과했습니다. 잠시 후 다시 시도하세요.");
                case 500, 503 ->
                        new GoogleTranslationException("Google Translation 서비스가 일시적으로 불가합니다.");
