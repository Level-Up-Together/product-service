...
/** 다국어 필드 선택 유틸리티 DB 다국어 컬럼 방식에서 locale에 따라 적절한 값을 반환 */
public class LocaleUtils {
    ...
    /** locale에 따라 적절한 텍스트 반환 (4개 언어) - 해당 locale 값이 있으면 반환 - 없으면 기본값(한국어) 반환 */
    ...
    public static String getLocalizedText(
            String defaultValue, String enValue, String arValue, String locale) {
