 ...
 * 비속어/금칙어 검증 어노테이션
 *
 * <p>DTO 필드에 적용하여 자동으로 비속어 검사를 수행합니다.
 *
 * <pre>
 * 사용 예시:
 * {@code
...
public @interface NoProfanity {
     ...
     *
     * <ul>
     *   <li>LENIENT: 단순 포함 여부만 검사
     *   <li>NORMAL (기본): 대소문자 무시 + 공백/특수문자 제거 + 초성 검사
     *   <li>STRICT: NORMAL + 레벤슈타인 거리 유사도 검사
     * </ul>
     */
     ...
     * 에러 메시지에 표시할 필드명 (한글)
     *
     * <p>예: "미션 제목" → "미션 제목에 부적절한 표현이 포함되어 있습니다."
     */
     ...
     * 한글 초성(자음) 검사 여부
     *
     * <p>true인 경우 "ㅅㅂ", "ㅂㅅ" 같은 초성 비속어도 탐지합니다. 주의: 초성 검사 시 "새벽", "사별" 등 일반 단어도 차단될 수 있어 기본값은
     * false입니다.
     */
     ...
     *
     * <p>0: 정확히 일치하는 경우만 탐지 (기본) 1: 1글자 오타까지 허용 (예: "시벌" → "시발" 탐지)
     */
