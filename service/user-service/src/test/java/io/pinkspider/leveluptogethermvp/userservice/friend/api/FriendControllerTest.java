                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.content[].friend_title").type(JsonFieldType.STRING).description("친구 칭호 (좌측, deprecated — friend_title_left 사용)").optional(),
                            fieldWithPath("value.content[].friend_title_left").type(JsonFieldType.STRING).description("친구 좌측 칭호").optional(),
                            fieldWithPath("value.content[].friend_title_left_rarity").type(JsonFieldType.STRING).description("친구 좌측 칭호 등급 (QA-114)").optional(),
                            fieldWithPath("value.content[].friend_title_right").type(JsonFieldType.STRING).description("친구 우측 칭호 (QA-93)").optional(),
                            fieldWithPath("value.content[].friend_title_right_rarity").type(JsonFieldType.STRING).description("친구 우측 칭호 등급 (QA-114)").optional(),
                            fieldWithPath("value.content[].equipped_item_rarities").type(JsonFieldType.ARRAY).description("장착 아이템 타입·희귀도 (썸네일 등급 표식용, LUT-424). 미장착 시 빈 배열").optional(),
                            ...
                            fieldWithPath("value.content[].equipped_item_rarities[].rarity").type(JsonFieldType.STRING).description("아이템 희귀도 (COMMON, UNCOMMON, RARE, EPIC, LEGENDARY, MYTHIC)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.friend_title").type(JsonFieldType.STRING).description("친구 칭호 (좌측, deprecated — friend_title_left 사용)").optional(),
                            fieldWithPath("value.friend_title_left").type(JsonFieldType.STRING).description("친구 좌측 칭호").optional(),
                            fieldWithPath("value.friend_title_left_rarity").type(JsonFieldType.STRING).description("친구 좌측 칭호 등급 (QA-114)").optional(),
                            fieldWithPath("value.friend_title_right").type(JsonFieldType.STRING).description("친구 우측 칭호 (QA-93)").optional(),
                            fieldWithPath("value.friend_title_right_rarity").type(JsonFieldType.STRING).description("친구 우측 칭호 등급 (QA-114)").optional(),
                            fieldWithPath("value.equipped_item_rarities").type(JsonFieldType.ARRAY).description("장착 아이템 타입·희귀도 (썸네일 등급 표식용, LUT-424). 목록 조회 시 제공 — 수락 응답은 빈 배열").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value[].friend_title").type(JsonFieldType.STRING).description("칭호 (좌측, deprecated)").optional(),
                            fieldWithPath("value[].friend_title_left").type(JsonFieldType.STRING).description("좌측 칭호").optional(),
                            fieldWithPath("value[].friend_title_left_rarity").type(JsonFieldType.STRING).description("좌측 칭호 등급 (QA-114)").optional(),
                            fieldWithPath("value[].friend_title_right").type(JsonFieldType.STRING).description("우측 칭호 (QA-93)").optional(),
                            fieldWithPath("value[].friend_title_right_rarity").type(JsonFieldType.STRING).description("우측 칭호 등급 (QA-114)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value[].friend_profile_image_url").type(JsonFieldType.STRING).description("프로필 이미지 URL").optional(),
                            fieldWithPath("value[].friend_level").type(JsonFieldType.NUMBER).description("친구 레벨").optional(),
                            fieldWithPath("value[].friend_title").type(JsonFieldType.STRING).description("친구 칭호 (좌측, deprecated)").optional(),
                            fieldWithPath("value[].friend_title_left").type(JsonFieldType.STRING).description("친구 좌측 칭호").optional(),
                            fieldWithPath("value[].friend_title_left_rarity").type(JsonFieldType.STRING).description("친구 좌측 칭호 등급 (QA-114)").optional(),
                            fieldWithPath("value[].friend_title_right").type(JsonFieldType.STRING).description("친구 우측 칭호 (QA-93)").optional(),
                            fieldWithPath("value[].friend_title_right_rarity").type(JsonFieldType.STRING).description("친구 우측 칭호 등급 (QA-114)").optional(),
