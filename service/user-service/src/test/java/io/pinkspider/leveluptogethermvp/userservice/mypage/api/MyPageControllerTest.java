                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.profile.left_title.name_ja").type(JsonFieldType.STRING).description("칭호 이름 (일본어)").optional(),
                            ...
                            fieldWithPath("value.profile.right_title.name_ja").type(JsonFieldType.STRING).description("칭호 이름 (일본어)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.titles[].name_ja").type(JsonFieldType.STRING).description("칭호 이름 (일본어)").optional(),
                            ...
                            fieldWithPath("value.titles[].description_ja").type(JsonFieldType.STRING).description("칭호 설명 (일본어)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.left_title.name_ja").type(JsonFieldType.STRING).description("칭호 이름 (일본어)").optional(),
                            ...
                            fieldWithPath("value.right_title.name_ja").type(JsonFieldType.STRING).description("칭호 이름 (일본어)").optional(),
