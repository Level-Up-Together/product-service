                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value[].name_ja").type(JsonFieldType.STRING).description("칭호 이름 (일본어)").optional(),
                            ...
                            fieldWithPath("value[].description_ja").type(JsonFieldType.STRING).description("칭호 설명 (일본어)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value[].description_ja").type(JsonFieldType.STRING).description("설명 (일본어)").optional(),
