...
class ActivityFeedControllerTest {
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.content[].user_title_rarity").type(JsonFieldType.STRING).description("칭호 등급 (COMMON, UNCOMMON, RARE, EPIC, LEGENDARY, MYTHIC)").optional(),
                            fieldWithPath("value.content[].user_title_color_code").type(JsonFieldType.STRING).description("칭호 색상 코드").optional(),
                            fieldWithPath("value.content[].user_left_title").type(JsonFieldType.STRING).description("좌측 칭호").optional(),
                            fieldWithPath("value.content[].user_left_title_rarity").type(JsonFieldType.STRING).description("좌측 칭호 등급").optional(),
                            fieldWithPath("value.content[].user_right_title").type(JsonFieldType.STRING).description("우측 칭호").optional(),
                            fieldWithPath("value.content[].user_right_title_rarity").type(JsonFieldType.STRING).description("우측 칭호 등급").optional(),
                            ...
                            fieldWithPath("value.content[].is_subscriber").type(JsonFieldType.BOOLEAN).description("작성자 구독자 여부 (구독자 뱃지용, LUT-455)").optional(),
                            fieldWithPath("value.content[].equipped_item_rarities[].item_type").type(JsonFieldType.STRING).description("아이템 타입 (HEAD/BACK/BASIC/FULL/EFFECT/ETC)").optional(),
                            fieldWithPath("value.content[].equipped_item_rarities[].rarity").type(JsonFieldType.STRING).description("아이템 희귀도").optional(),
                            ...
                            fieldWithPath("value.content[].guild_name").type(JsonFieldType.STRING).description("길드명").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.user_title").type(JsonFieldType.STRING).description("사용자 칭호").optional(),
                            fieldWithPath("value.user_title_rarity").type(JsonFieldType.STRING).description("칭호 등급 (COMMON, UNCOMMON, RARE, EPIC, LEGENDARY, MYTHIC)").optional(),
                            fieldWithPath("value.user_title_color_code").type(JsonFieldType.STRING).description("칭호 색상 코드").optional(),
                            fieldWithPath("value.user_left_title").type(JsonFieldType.STRING).description("좌측 칭호").optional(),
                            fieldWithPath("value.user_left_title_rarity").type(JsonFieldType.STRING).description("좌측 칭호 등급").optional(),
                            fieldWithPath("value.user_right_title").type(JsonFieldType.STRING).description("우측 칭호").optional(),
                            fieldWithPath("value.user_right_title_rarity").type(JsonFieldType.STRING).description("우측 칭호 등급").optional(),
                            ...
                            fieldWithPath("value.is_subscriber").type(JsonFieldType.BOOLEAN).description("작성자 구독자 여부 (구독자 뱃지용, LUT-455)").optional(),
                            ...
                            fieldWithPath("value.guild_name").type(JsonFieldType.STRING).description("길드명").optional(),
                            ...
                            fieldWithPath("value.is_my_feed").type(JsonFieldType.BOOLEAN).description("내가 작성한 피드인지"),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.content[].user_left_title").type(JsonFieldType.STRING).description("작성자 좌측 칭호 (LUT-422, 미장착 시 null)").optional(),
                            fieldWithPath("value.content[].user_left_title_rarity").type(JsonFieldType.STRING).description("작성자 좌측 칭호 희귀도 (LUT-422)").optional(),
                            fieldWithPath("value.content[].user_right_title").type(JsonFieldType.STRING).description("작성자 우측 칭호 (LUT-422, 미장착 시 null)").optional(),
                            fieldWithPath("value.content[].user_right_title_rarity").type(JsonFieldType.STRING).description("작성자 우측 칭호 희귀도 (LUT-422)").optional(),
                            fieldWithPath("value.content[].equipped_item_rarities").type(JsonFieldType.ARRAY).description("작성자 장착 아이템 타입·희귀도 (썸네일 등급 표식용, LUT-424)").optional(),
                            fieldWithPath("value.content[].is_subscriber").type(JsonFieldType.BOOLEAN).description("작성자 구독자 여부 (구독자 뱃지용, LUT-455)").optional(),
                            fieldWithPath("value.content[].equipped_item_rarities[].item_type").type(JsonFieldType.STRING).description("아이템 타입 (HEAD/BACK/BASIC/FULL/EFFECT/ETC)").optional(),
                            fieldWithPath("value.content[].equipped_item_rarities[].rarity").type(JsonFieldType.STRING).description("아이템 희귀도").optional(),
    ...
    @Test
    @DisplayName("GET /api/v1/feeds/user/{targetUserId} : 특정 사용자 피드 조회")
    void getUserFeedsTest() throws Exception {
        ...
        when(feedQueryService.getUserFeeds(anyString(), anyString(), anyInt(), anyInt(), any()))
            .thenReturn(responses);

        // when
        ResultActions resultActions = mockMvc.perform(
            RestDocumentationRequestBuilders.get("/api/v1/feeds/user/{targetUserId}", targetUserId)
                .with(user(MOCK_USER_ID))
                .param("page", "0")
                .param("size", "20")
                .contentType(MediaType.APPLICATION_JSON)
        ).andDo(
            MockMvcRestDocumentationWrapper.document("피드-11. 특정 사용자 피드 조회",
                preprocessRequest(prettyPrint()),
                preprocessResponse(prettyPrint()),
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Activity Feed")
                        .description("특정 사용자의 공개 피드 목록 조회 (JWT 토큰 인증 필요)")
                        .pathParameters(
                            parameterWithName("targetUserId").type(SimpleType.STRING).description("조회할 대상 사용자 ID")
                        )
                        .queryParameters(
                            parameterWithName("page").type(SimpleType.NUMBER).description("페이지 번호 (0부터 시작)").optional(),
                            parameterWithName("size").type(SimpleType.NUMBER).description("페이지 크기").optional()
