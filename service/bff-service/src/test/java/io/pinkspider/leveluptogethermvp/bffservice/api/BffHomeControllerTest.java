                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.my_guilds[].total_point").type(JsonFieldType.NUMBER).description("누적 활동 포인트 (랭킹·레벨 기준, LUT-483)").optional(),
                            fieldWithPath("value.my_guilds[].current_point").type(JsonFieldType.NUMBER).description("현재 레벨에서의 포인트 (LUT-483)").optional(),
                            ...
                            fieldWithPath("value.public_guilds.content[].total_point").type(JsonFieldType.NUMBER).description("누적 활동 포인트 (랭킹·레벨 기준, LUT-483)").optional(),
                            fieldWithPath("value.public_guilds.content[].current_point").type(JsonFieldType.NUMBER).description("현재 레벨에서의 포인트 (LUT-483)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.guild.total_point").type(JsonFieldType.NUMBER).description("누적 활동 포인트 (랭킹·레벨 기준, LUT-483)").optional(),
                            fieldWithPath("value.guild.current_point").type(JsonFieldType.NUMBER).description("현재 레벨에서의 포인트 (LUT-483)").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.recommended_guilds.content[].total_point").type(JsonFieldType.NUMBER).description("누적 활동 포인트 (랭킹·레벨 기준, LUT-483)").optional(),
                            fieldWithPath("value.recommended_guilds.content[].current_point").type(JsonFieldType.NUMBER).description("현재 레벨에서의 포인트 (LUT-483)").optional(),
                            ...
                            fieldWithPath("value.guild_activity_feeds.content[].guild_name").type(JsonFieldType.STRING).description("길드명").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.my_missions[].total_exp_earned").type(JsonFieldType.NUMBER).description("미션 누적 EXP").optional(),
