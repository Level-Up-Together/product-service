                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.rank_rewards[].rank_range_display_en").type(JsonFieldType.STRING).description("순위 범위 표시명 (영어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].rank_range_display_ar").type(JsonFieldType.STRING).description("순위 범위 표시명 (아랍어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].rank_range_display_ja").type(JsonFieldType.STRING).description("순위 범위 표시명 (일본어, LUT-414)").optional(),
                            ...
                            fieldWithPath("value.rank_rewards[].category_name_en").type(JsonFieldType.STRING).description("카테고리명 (영어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].category_name_ar").type(JsonFieldType.STRING).description("카테고리명 (아랍어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].category_name_ja").type(JsonFieldType.STRING).description("카테고리명 (일본어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].ranking_type_display").type(JsonFieldType.STRING).description("랭킹 유형 표시명"),
                            fieldWithPath("value.rank_rewards[].ranking_type_display_en").type(JsonFieldType.STRING).description("랭킹 유형 표시명 (영어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].ranking_type_display_ar").type(JsonFieldType.STRING).description("랭킹 유형 표시명 (아랍어, LUT-414)").optional(),
                            fieldWithPath("value.rank_rewards[].ranking_type_display_ja").type(JsonFieldType.STRING).description("랭킹 유형 표시명 (일본어, LUT-414)").optional(),
                            ...
                            fieldWithPath("value.rank_rewards[].title_name_en").type(JsonFieldType.STRING).description("보상 칭호명 (영어, LUT-420 — 미등록 시 null, ko 폴백)").optional(),
                            fieldWithPath("value.rank_rewards[].title_name_ar").type(JsonFieldType.STRING).description("보상 칭호명 (아랍어, LUT-420)").optional(),
                            fieldWithPath("value.rank_rewards[].title_name_ja").type(JsonFieldType.STRING).description("보상 칭호명 (일본어, LUT-420)").optional(),
                            ...
                            fieldWithPath("value.categories[].name_ja").type(JsonFieldType.STRING).description("카테고리명 (일본어)").optional(),
                            ...
                            fieldWithPath("value.categories[].description_ja").type(JsonFieldType.STRING).description("카테고리 설명 (일본어)").optional(),
