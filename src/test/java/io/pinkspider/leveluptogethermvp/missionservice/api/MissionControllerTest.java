                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .requestFields(
                            ...
                            fieldWithPath("start_date").type(JsonFieldType.STRING).description("시작일").optional(),
                            fieldWithPath("end_date").type(JsonFieldType.STRING).description("종료일").optional(),
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.start_date").type(JsonFieldType.STRING).description("시작일").optional(),
                            fieldWithPath("value.end_date").type(JsonFieldType.STRING).description("종료일").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.content[].start_date").type(JsonFieldType.STRING).description("시작일").optional(),
                            fieldWithPath("value.content[].end_date").type(JsonFieldType.STRING).description("종료일").optional(),
        ...
        ResultActions resultActions = mockMvc.perform(
            ...
            MockMvcRestDocumentationWrapper.document("06. 미션 수정",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Mission")
                        .description("미션 정보 수정 (DRAFT 상태일 때만 가능)")
                        .requestHeaders(
                            headerWithName(X_USER_ID).description("사용자 ID")
                        )
                        .pathParameters(
        ...
        ResultActions resultActions = mockMvc.perform(
            ...
            MockMvcRestDocumentationWrapper.document("07. 미션 모집 시작",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Mission")
                        .description("미션 상태를 OPEN으로 변경하여 참여자 모집 시작")
                        .requestHeaders(
                            headerWithName(X_USER_ID).description("사용자 ID")
                        )
                        .pathParameters(
        ...
        ResultActions resultActions = mockMvc.perform(
            ...
            MockMvcRestDocumentationWrapper.document("08. 미션 진행 시작",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Mission")
                        .description("미션 상태를 IN_PROGRESS로 변경하여 미션 진행 시작")
                        .requestHeaders(
                            headerWithName(X_USER_ID).description("사용자 ID")
                        )
                        .pathParameters(
        ...
        ResultActions resultActions = mockMvc.perform(
            ...
            MockMvcRestDocumentationWrapper.document("09. 미션 완료",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Mission")
                        .description("미션 상태를 COMPLETED로 변경")
                        .requestHeaders(
                            headerWithName(X_USER_ID).description("사용자 ID")
                        )
                        .pathParameters(
        ...
        ResultActions resultActions = mockMvc.perform(
            ...
            MockMvcRestDocumentationWrapper.document("10. 미션 취소",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Mission")
                        .description("미션 상태를 CANCELLED로 변경")
                        .requestHeaders(
                            headerWithName(X_USER_ID).description("사용자 ID")
                        )
                        .pathParameters(
        ...
        ResultActions resultActions = mockMvc.perform(
            ...
            MockMvcRestDocumentationWrapper.document("11. 미션 삭제",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        .tag("Mission")
                        .description("미션 삭제 (IN_PROGRESS 상태가 아닐 때만 가능)")
                        .requestHeaders(
                            headerWithName(X_USER_ID).description("사용자 ID")
                        )
                        .pathParameters(
