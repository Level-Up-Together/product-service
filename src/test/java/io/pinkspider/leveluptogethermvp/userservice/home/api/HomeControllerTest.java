                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value[].title_color_code").type(JsonFieldType.STRING).description("칭호 색상 코드").optional(),
                            ...
                            fieldWithPath("value[].left_title_color_code").type(JsonFieldType.STRING).description("왼쪽 칭호 색상 코드").optional(),
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .responseFields(
                            ...
                            fieldWithPath("value.season_mvp_players[].title_color_code").type(JsonFieldType.STRING).description("칭호 색상 코드").optional(),
                            ...
                            fieldWithPath("value.season_mvp_players[].left_title_color_code").type(JsonFieldType.STRING).description("왼쪽 칭호 색상 코드").optional(),
