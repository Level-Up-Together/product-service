...
import io.pinkspider.leveluptogethermvp.feedservice.core.properties.FeedDataSourceProperties;
...
@Slf4j
public class FeedDataSourceConfig {

    private final FeedDataSourceProperties properties;
    private final SshTunnel sshTunnel;

    public FeedDataSourceConfig(FeedDataSourceProperties properties, SshTunnel sshTunnel) {
