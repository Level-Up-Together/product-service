...
public class QuestService {
    ...
    public void initializeDefaultQuests() {
        ...
        // 일일 퀘스트
        createQuest("출석 체크하기", "오늘 출석 체크를 완료하세요", QuestType.DAILY,
            QuestCategory.ATTENDANCE, QuestActionType.CHECK_IN, 1, 10, 1);
        createQuest("미션 1개 완료", "미션을 1개 완료하세요", QuestType.DAILY,
            QuestCategory.MISSION, QuestActionType.COMPLETE_MISSION, 1, 20, 2);
        createQuest("미션 3개 완료", "미션을 3개 완료하세요", QuestType.DAILY,
            QuestCategory.MISSION, QuestActionType.COMPLETE_MISSIONS, 3, 50, 3);
        createQuest("경험치 100 획득", "경험치를 100 이상 획득하세요", QuestType.DAILY,
            QuestCategory.LEVEL, QuestActionType.GAIN_EXP, 100, 30, 4);

        // 주간 퀘스트
        createQuest("7일 연속 출석", "7일 연속으로 출석하세요", QuestType.WEEKLY,
            QuestCategory.ATTENDANCE, QuestActionType.CONSECUTIVE_ATTENDANCE, 7, 100, 1);
        createQuest("미션 10개 완료", "이번 주에 미션을 10개 완료하세요", QuestType.WEEKLY,
            QuestCategory.MISSION, QuestActionType.COMPLETE_MISSIONS, 10, 150, 2);
        createQuest("길드 미션 5개 완료", "이번 주에 길드 미션을 5개 완료하세요", QuestType.WEEKLY,
            QuestCategory.GUILD, QuestActionType.COMPLETE_GUILD_MISSION, 5, 200, 3);
        createQuest("레벨업 달성", "이번 주에 레벨업을 하세요", QuestType.WEEKLY,
            QuestCategory.LEVEL, QuestActionType.LEVEL_UP, 1, 100, 4);

        log.info("기본 퀘스트 초기화 완료");
    }

    private Quest createQuest(String name, String description, QuestType type,
                               QuestCategory category, QuestActionType actionType,
                               int requiredCount, int rewardExp, int sortOrder) {
