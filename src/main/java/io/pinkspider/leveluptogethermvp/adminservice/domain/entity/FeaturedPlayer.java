...
@AllArgsConstructor
@Table(name = "featured_player",
    uniqueConstraints = @UniqueConstraint(
        name = "uk_featured_player",
        columnNames = {"category_id", "user_id"}
    )
)
@Comment("카테고리별 추천 플레이어")
public class FeaturedPlayer extends LocalDateTimeBaseEntity {
